...
export function PublicEvent() {
  ...
  return <div className="public-event-feature">
    ...
    {showEmbed && <section className="embed-panel"><div><Code2/><h2>Embed this public agenda</h2><p>Paste this iframe into an event site. It always displays the published agenda from this browser workspace.</p></div><pre>{embedCode}</pre><button onClick={copyEmbed}>{copied ? <Check size={16}/> : <Clipboard size={16}/>} {copied ? 'Copied' : 'Copy embed code'}</button></section>}
